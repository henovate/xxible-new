...
const EventCard4 = ({cardData}:EventCard4Props) => {
  return (
	<>
		<div className="card5 relative h-[250px] w-[250px] rounded-full" style={{background: `url(${cardData.image})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center"}}>
