...
export default function Home() {
  ...
  "
                      >
                        Find The Hottest <span className="text-fuchsia-500">Events</span>
                        <br />
                        And <span className="text-fuchsia-500">Meet</span> New People
                      </h1>
          ...
          <div className="sec3 px-5 lg:px-8 xl:px-16 pt-[10px] bg-[#EDEDED] w-full text-[#212121] pb-10">
            ...
            <div className='createBrand bg-[#000000] bg-[url("/assets/bg.png")] bg-cover bg-no-repeat bg-center rounded-[32px] mt-[72px] pt-[70px] xl:pt-[113px] pb-[69px] xl:pb-[112.14px] w-full px-8 sm:px-14'>
              <div className="w-full sm:w-[70%] xl:w-[50%]">
                <p className="text-[30px] leading-[35px] xl:text-[48px] xl:leading-[47px] py-3 font-[600] text-transparent bg-clip-text bg-gradient-to-r from-[#FFFFFF] via-pink-500 to-[#e28edb] overflow-visible">
                  Create Your brand Claim Your Spotlight!
                </p>
                <p className="text-[16px] leading-[20px] sm:leading-[22px] xl:text-[24px] xl:leading-[34px] font-[400] my-8 text-[#ffffff] lg:w-[70%] xl:w-full">
                  Build your presence, host unforgettable nights, and connect
                  directly with your crowd, whether you're a buzzing lounge, a
                  rooftop bar, or an underground party brand.
                </p>
