...
const Page = () => {
  ...
  return (
    ...
    <div className="flex-1 flex items-center justify-center w-full h-full p-4 sm:px-0">
      <div className="w-full max-w-[540px] bg-white rounded-2xl shadow-xl p-8 lg:py-[60.23px] lg:px-[45px]">
        {/* Header */}
          ...
          <div className="text-center mb-[32px]">
            ...
            <div className='flex justify-center items-center w-full'>
              <p className="text-[#A0A0A0] text-[13px] font-[500] w-[70%] sm:w-full">
        ...
        <div className='sm:px-4'>
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full text-[13px] bg-gray-900 text-white mt-[28px] py-2 px-4 rounded-lg font-medium hover:bg-gray-800 transition-colors focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 outline-none"
            >
              Sign up
            </button>
          </form>
