    ...
    <>
      {type === "checkbox" ? (
        <div className="flex items-center">
          ...
          <label
            htmlFor={name}
            className="ml-2 text-[13px] 2xl:text-[14px] text-gray-700 cursor-pointer select-none"
          >
            {label}
          </label>
        </div>
        ...
        <div className="relative">
          <div
            className={`${classes} absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none`}
          >
