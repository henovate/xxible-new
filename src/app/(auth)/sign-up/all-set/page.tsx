  ...
  return (
		...
		<div className="container sign-up-cont min-h-screen bg-gray-100 flex flex-col pt-7 pb-16">
			...
			<div className='flex-1 flex items-center justify-center w-full px-4 sm:px-0'>
				<div className="w-full max-w-[593px] 2xl:max-w-[650px]  bg-[url('/assets/img/bg3.png')] bg-cover bg-center bg-no-repeat bg-white rounded-2xl shadow-xl p-8 lg:py-[70.23px] lg:px-[59px]">
					{/* Header */}
					<div className="text-center mb-[52px]">
						...
						<div className='flex justify-center'>
							<p className="text-[#A0A0A0] text-sm 2xl:text-[16px] font-[500] lg:w-[75%]">
					...
					<div>
						<div className='flex justify-center items-center'>
							<div className="h-[200px] w-[200px] 2xl:h-[351px] 2xl:w-[341px] ">
